...
os.system('xdg-open https://github.com/SK-SIDDIK-143')
...
Shawponx = input(f'\x1b[38;5;46m ─> \x1b[1;95mYOUR NAME {x}> \033[93m')
os.system('xdg-open https://github.com/SK-SIDDIK-143/auto-share')
###----------[ LOGIN MINU ]----------###	
def login():
	os.system("clear")
	banner()	
	...
	sol().print(cik2)
	cookie = input(f"{GREEN}{SIDDIK} YOUR COOKIE ─> : {x}")
	try:
...
def bot_share():
	...
	os.system('clear')
	banner()
	cetak(nel(f'''{B2} User Name  : {H2}{SIDDIK} 
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'{P}\r   └──>{H} {bas} SP-BD{H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',end='');sys.stdout.flush()
			else:
				print("\n")
				cetak(nel(f'{M2} YOUR COOKIE IS INVALID',width=35,padding=0,style='red'));exit()
	except requests.exceptions.ConnectionError:
		print(f"\n{P}(!)check internet data !😵");exit()
bot_share()
